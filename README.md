...
## ■ 職務要約
Web開発エンジニアとして約8年の経験を持ち、現在は受託開発企業の開発チームリーダーを務めております。
...
要件定義からAWSインフラ、アプリケーションまでを一気通貫で対応できることに強みがあると考えております。
AWSについては、LambdaやECS on Fargate等を利用したクラウドネイティブな設計から、VPCピアリングやSite to Site VPNを使用した複雑なネットワーク設計にも対応可能です。

### 2. 自動テスト導入による品質と心理的安全性を
